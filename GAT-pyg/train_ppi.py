...
from models.models import GAT_PPI
...
def train():
    ...
    model = GAT_PPI(train_dataset.num_features, train_dataset.num_classes).to(device)
...
def get_args():
    ...
    parser.add_argument('--domain', type=str, default='PubMed', help='which dataset to be used')
