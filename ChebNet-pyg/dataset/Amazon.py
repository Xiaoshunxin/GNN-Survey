...
if __name__ == '__main__':
    # datasets = Coauthor(root='/home/amax/xsx/data/gnn_datas/Coauthor/CS', name='CS')
    datasets = Coauthor(root='/home/amax/xsx/data/gnn_datas/Coauthor/Physics', name='Physics')
