...
from models.models import My_APPNP
...
def train():
    ...
    model = My_APPNP(dataset.num_features, args.hidden_dim, dataset.num_classes, args.dropout, args.K, args.alpha).to(device)
...
def get_args():
    ...
    parser.add_argument('--K', type=int, default=10, help='Number of propagation layers.')
    parser.add_argument('--alpha', type=float, default=0.1, help='the value of alpha.')
