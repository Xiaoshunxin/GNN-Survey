...
def train():
    ...
    model = SGC(dataset.num_features, int(dataset.num_classes), args.K).to(device)
    ...
    print("Total epochs: {:2d}".format(total_epoch))
...
def get_args():
    ...
    parser.add_argument('--K', type=int, default=2, help='Number of hidden units.')
